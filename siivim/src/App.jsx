        ...
        return (
          <div>
            <header className="header">
              ...
              <div className="button-container" style={{marginTop: '1.3rem'}}>
                <div className="parallelogram"></div>
            ...
            <div className="info-content" style={{marginTop: '2rem' }}>
              <div className="parallelogram2" style={{ marginLeft: '0rem', marginTop: '2rem' }}></div>
              <h1 className="INSTRUCTIONS" style={{ marginTop: '-29.5rem', marginLeft: '-60rem' }}>Instructions</h1>
              <img className="kevin" src='../image/kevin.webp' style={{marginLeft: '-22.5rem', marginTop: '2rem'}} alt="Image" />
              ...
              <a className="Regl" style={{ marginLeft: '-60rem', marginTop: '10rem'}} href="/ppt/reglement.pdf" download>Télécharger le réglement du tournoi ici.</a>
              <h2 style={{ marginTop: '25rem' , marginLeft: '-60rem'}}>Conditions d'éligibilité</h2>
              ...
              <h2 style={{ marginTop: '2rem' }}>Âge minimum requis</h2>
              ...
              <h2 style={{ marginTop: '2rem' }}>Calendrier des parties</h2>
